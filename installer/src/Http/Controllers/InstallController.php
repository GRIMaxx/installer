...
namespace Gtx\Installer\Http\Controllers;

use BaseHelper;
use Gtx\ACL\Models\User;
use Gtx\ACL\Services\ActivateUserService;
use Gtx\Installer\Events\EnvironmentSaved;
use Gtx\Installer\Events\InstallerFinished;
use Gtx\Installer\Http\Requests\SaveAccountRequest;
use Gtx\Installer\Http\Requests\SaveEnvironmentRequest;
use Gtx\Installer\Supports\EnvironmentManager;
use Gtx\Installer\Supports\RequirementsChecker;
use Carbon\Carbon;
use Exception;
use File;
